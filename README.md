khob farbod Step aval ine ke 
<H1>STEP-1:</H1>beri dakhele script.google.com
omidvaram ke onja already proje nadashte bashi ama agar dariam ehtemalan mohem nis vali tarjihan age dari ba ye google accountit boro to in site ke proje nadari already 




<H1>Step-3:</H1>:
ye new project misazi va 4 line code e default esh ro remove mikoni
va matne dakhele thecode.txt ro copy mikoni va toosh paste mikoni 



<H1>Step-3:</H1>:
mizani roye deploy baadesh new deployment 

type esh ro mizari web app

description mohem nis  

excecute as bayad rooye ME bashe 


who has access bayad rooye anyone bashe
...
const AUTH_KEY = "AmaterasuIsMYS*cr!t";
